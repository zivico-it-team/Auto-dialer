...
router.post('/', requireRoles(['ADMIN', 'SUPERVISOR']), validateBody(createAgentSchema), AgentController.create);
router.delete('/:id', requireRoles(['ADMIN', 'SUPERVISOR']), AgentController.delete);
